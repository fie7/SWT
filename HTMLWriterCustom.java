 ...
 * </ul>
 */
class HTMLWriterCustom extends StyledTextWriterBaseCustom {
    private String tag;
    private boolean multiline;

    public HTMLWriterCustom(StyledTextCustom styledText, int start, int length, StyledTextContent content) {
