 ...
 */
abstract class StyledTextWriterBaseCustom extends TextWriter {
    final StyledTextCustom styledText;
     ...
     */
    public StyledTextWriterBaseCustom(StyledTextCustom styledText, int start, int length) {
        super(start, length);
